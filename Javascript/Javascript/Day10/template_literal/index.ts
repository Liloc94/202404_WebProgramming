...
const isBookSale = (book: tempObjType): Number =>
  book.isSale ? book.price * 0.9 : book.price;
...
const makeBook = (book: tempObjType) =>
  `
<h1>${book.title}</h1>
<h3>${book.author}</h3>
