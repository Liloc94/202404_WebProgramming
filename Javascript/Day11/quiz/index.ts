...
const makeImgTag = (imageURL: String): String =>
  `<img class="userImg" src="${imageURL}" alt="">`;

const makeEmailTag = (email: String): String => {
  const userEmail = email.split("@")[0];
  return `<span class="userEmail">${userEmail}</span>`;
};

const makeSSN = (ssn: String): String => `<span class="userSSN">${ssn}</span>`;

const makeCardNum = (cardNumber: String) => {
...
const makeCard = (dataArr: objType) =>
  `
